...
function App() {
  return (
    <div className="App">
      ...
      or: 'red' } }} imgsrc="http://wallpapercave.com/wp/wp4056410.jpg" atls="AA" /> 
        <Card3 bgclr="#0dcaf0" imgsrc="http://wallpapercave.com/wp/wp4056410.jpg" atls="AA" />
        <Card3 imgsrc="./logo/fauji foundation.png" bgclr="#d154e3" />
        <Card3 imgsrc="FAAD_SIR.png" bgclr="#ffab00" />
      </div> */}
      ...
      {/* <Footer2a /> */}
      <Footer3a />
      {/* Create Custom Componet/Scripts and Insert Scripts tag here like  <scripts/> same tag in the start of this Area line <css/>  */}
    </div >
